...
def create_submission(prediction, score):
    ...
    sub_file = '..../Desktop/PyML/Housing_price_prediction/submission_' + str(score) + '_' + str(now.strftime("%Y-%m-%d-%H-%M")) + '.csv'
...
train = pd.read_csv("..../Desktop/PyML/Datasets/house_price_pred_trainingdata.csv")
test = pd.read_csv("..../Desktop/PyML/Datasets/house_price_pred_testdata.csv")
